                 ...
                 ${isActive ? "bg-white py-4 shadow-md" : "bg-none py-6 text-white"} `}>
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div className="flex items-center lg:order-2">
                            <Link href="/login" className="hover:bg-gray-50 hover:text-black focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">Log in</Link>
